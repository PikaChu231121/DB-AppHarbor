<template>
    <div class="report-list">
        ...
        <div v-if="selectedReport" class="detail-popup">
            ...
            <p style="font-size: 17px;"><strong style="font-size: 19px; font-weight: bolder">受理时间:&nbsp;&nbsp;&nbsp;</strong> {{ selectedReport.reviewInfo.reviewTime }}</p>
            <p style="font-size: 17px;"><strong style="font-size: 19px; font-weight: bolder">受理结果:&nbsp;&nbsp;&nbsp;</strong> {{ selectedReport.reviewInfo.reviewResult }}</p>
            <p style="font-size: 17px;"><strong style="font-size: 19px; font-weight: bolder">受理管理员ID:&nbsp;&nbsp;&nbsp;</strong> {{ selectedReport.reviewInfo.adminId }}</p>
...
<style scoped>
    ...
    th {
        ...
        color: #fff;
        font-size: 1.2em; /* Font size for table headers, already increased */
    }
    ...
    th {
        background-color: #ebbfb8;
        color: #fff;
        font-size: 1.2em; /* Increased font size for table headers */
    }
    ...
    tbody tr {
        ...
        tbody tr:hover {
            background-color: #f9d9d9; /* Changed hover background color to a lighter pink */
        }
    ...
    .detail-popup {
        ...
        .detail-popup p {
            ...
            word-break: break-all; /* 强制换行，防止长单词超出容器 */
            white-space: normal; /* 允许文本换行 */
            max-width: 100%; /* 限制宽度，使内容不超出弹窗边界 */
            overflow-wrap: break-word; /* 避免单词超出容器边界 */
        }

        .content-popup button,
        .detail-popup button {
            position: absolute; /* Position button absolutely within the popup */
            bottom: 20px;
            right: 20px;
            padding: 10px 20px;
            background-color: #ebbfb8;
