    ...
    export default {
        ...
        methods: {
             async fetchApps(page = 1) {
                ...
                try {
                    const response = await axios.post('/api/merchant/getApps', formData);
            ...
            async updateApp(app) {
                ...
                try {
                    await axios.post('/api/merchant/updateApp', formData);
            ...
            async deleteApp() {
                ...
                try {
                    await axios.post('/api/merchant/deleteApp', formData);
            ...
            async uploadNewImage() {
                ...
                try {
                    await axios.post('/api/merchant/upload-app-img', formDataImg);
            ...
            async uploadNewAppFile() {
                ...
                try {
                    await axios.post('/api/merchant/uploadapp', formDataAppFile);
